 ...
 * {@link NightScheduleFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NightScheduleFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NightScheduleFragment extends Fragment implements IFabFragment
{
     ...
     * @return A new instance of fragment NightScheduleFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NightScheduleFragment newInstance(Schedule param1)
    {
        NightScheduleFragment fragment = new NightScheduleFragment();
    ...
    private void fillScheduleTable(View view)
    {
        ...
        Map<LocalDate, List<Resident>> nightShifts = getSchedule().getNightShifts();
        if (nightShifts.isEmpty())
            return;

        Set<LocalDate> localDates = nightShifts.keySet();
        ...
        for (LocalDate date = startDate; date.isBefore(endDate.plusDays(1)); date = date.plusDays(1))
        {
            ...
            button.setText(Utils.listToString(nightShifts.get(date)));
    ...
    private void showEditDialog(final LocalDate date, final Button button)
    {
        ...
        for (Resident resident : getSchedule().getNightShifts().get(date))
        {
        ...
        alertDialogBuilder.setCancelable(false)
                .setPositiveButton("OK", new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int id)
                    {
                        ...
                        getSchedule().getNightShifts().put(date, residents);
    ...
    public void configFab(FloatingActionButton resultFab)
    {
        resultFab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                try
                {
                    PdfUtil.writeNightShiftSchedule(getSchedule());
                    Toast.makeText(getContext(), "saved in " + schedule.getName() + "-night.pdf", Toast.LENGTH_LONG).show();
                }
